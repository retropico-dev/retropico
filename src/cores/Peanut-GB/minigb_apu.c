...
static __force_inline void set_note_freq(struct chan *c, const uint32_t freq) {
...
static __force_inline void update_env(struct chan *c) {
...
static __force_inline void update_len(struct chan *c) {
    if (!c->len.enabled)
        return;
...
static __force_inline bool update_freq(struct chan *c, uint32_t *pos) {
...
static __force_inline void update_sweep(struct chan *c) {
