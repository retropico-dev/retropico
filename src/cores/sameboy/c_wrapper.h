...
#ifndef MICROBOY_C_WRAPPER_H
#define MICROBOY_C_WRAPPER_H

//
// TODO: GB_ENUM C -> CPP fix:
// external/cores/SameBoy/Core/save_state.h:31:47: error: types may not be defined in casts
